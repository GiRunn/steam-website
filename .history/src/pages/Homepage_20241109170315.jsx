              ...
              >
                <div className="relative w-48">
                  <img
                    src={brand.image}
                    alt={brand.name}
                    className="w-full h-20 object-contain opacity-50 group-hover:opacity-100 transition-all duration-500 filter grayscale group-hover:grayscale-0"
                  />
                  {/* 悬浮光效 */}
                  <div 
                  ...
                  {/* 底部光线 */}
                  <div 
                    className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3/4 h-1 opacity-0 group-hover:opacity-100 transition-all duration-500"
                    style={{
