...
import { Send, Image as ImageIcon, Smile, Hash, AtSign, Link2, MessageCircle, PenTool } from 'lucide-react';
       ...
       <div className="relative group">
         <textarea
           ...
           className={`
             ...
             rounded-xl resize-none p-4 pr-20
       ...
       <AnimatePresence>
         {showEmoji && (
           <motion.div 
             ...
             className="absolute right-0 top-full mt-2 shadow-xl"
           >
             <EmojiPicker
