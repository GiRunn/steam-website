...
const ServiceInfoSection = React.lazy(() => import('./components/ServiceInfoSection'));
          ...
          <div className="flex-1 overflow-hidden flex flex-col relative">
            {serviceAgent && chatState === ChatState.CONNECTED && (
              <ServiceInfoSection 
                ...
                onQuickReplySelect={(reply) => handleSendMessage({ text: reply, isUser: true })}
              />
            )}
            ...
            <ChatControls
              ...
              onSendMessage={handleSendMessage}
              onQuickReplyOpen={setIsQuickReplyOpen}
            />
          </div>
        </Suspense>
      </div>
