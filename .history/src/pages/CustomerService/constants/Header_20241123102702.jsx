...
const SearchBox = ({ searchTerm, setSearchTerm, onExpand }) => {
  ...
  className="px-4 py-1.5 bg-blue-500/20 hover:bg-blue-500/30 
    ...
    relative flex items-center justify-center w-full"  {/* 使用 relative 定位 */}
>
  <span className="absolute left-1/2 -translate-x-1/2">搜索</span>  {/* 使用绝对定位居中 */}
  <div className="hidden sm:flex items-center gap-1 px-0.5 border-l border-blue-500/30 ml-auto">
    {/* 快捷键内容 */}
  </div>
</motion.button>
            </div>
    ...
    <div className="mb-12">
      ...
      >
        ...
        <motion.div 
          ...
          initial={{ paddingTop: "4rem", paddingBottom: "4rem" }}
          animate={{ 
            paddingTop: "4rem",
            paddingBottom: isSearchExpanded ? "14rem" : "4rem"
          }}
          transition={{ 
            duration: 0.3,
