...
const UserCenter = lazy(() => import('./pages/UserCenter/UserCenter').then(module => ({ default: module.default })));
          ...
          <AnimatePresence mode="wait">
            <Routes location={location} key={`route-${location.pathname}`}>
              ...
              <Route 
                ...
                element={
                  <Suspense fallback={<LoadingScreen />}>
                    <motion.div {...pageTransition} key={`motion-user-center`}>
                      <ProtectedRoute>
              ...
              <Route path="/" 
                element={
                  <Suspense fallback={<LoadingScreen />}>
                    <motion.div {...pageTransition} key={`motion-home`}>
              ...
              <Route path="/store" 
                element={
                  <Suspense fallback={<LoadingScreen />}>
                    <motion.div {...pageTransition} key={`motion-store`}>
                      <Store {...sharedProps} />
                    </motion.div>
                  </Suspense>
                } 
              ...
              <Route path="/login" 
                element={
                  <Suspense fallback={<LoadingScreen />}>
                    <motion.div {...pageTransition} key={`motion-login`}>
                      <Login {...sharedProps} />
                    </motion.div>
                  </Suspense>
                } 
