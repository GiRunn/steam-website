            ...
            <div className="flex-1 overflow-hidden flex flex-col relative">
              ...
              <div className="flex flex-col">
                {chatState === ChatState.BOT ? (
                  <UserInfo 
                    user={BOT_INFO}
                    className="bg-gradient-to-br from-blue-900/30 to-indigo-900/30 
                      border-blue-800/30 hover:border-blue-700/50 transition-colors duration-300"
                  />
                ) : (
              ...
              {(chatState === ChatState.CONNECTED || chatState === ChatState.BOT) && (
                <div className="border-t border-gray-800/30">
                  <MessageInput 
                    ...
                    isTyping={isAgentTyping}
                    placeholder={
                      isAgentTyping ? "AI助手正在思考..." : 
                      chatState === ChatState.BOT ? "请输入您的问题..." :
                      "输入消息..."
                    }
