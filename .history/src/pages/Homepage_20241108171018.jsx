...
const Homepage = () => {
  ...
  return (
    ...
    <div 
      ...
      className={`
        relative py-20 
        ${darkMode ? 'bg-steam-dark' : 'bg-gray-900'}
        overflow-hidden
      `}
    >
      {/* 背景动效 */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0 bg-gradient-to-r from-steam-blue to-purple-600 animate-gradient-x"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {gameFeatures.map((feature, index) => (
              <div 
                key={index}
                className={`
                  bg-gradient-to-br from-steam-light to-steam-dark
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              >
                ...
                <button className="
                  ...
                  shadow-lg hover:shadow-steam-blue/50
                ">
                  {t.buttons.learnMore}
                </button>
              </div>
              ...
              >
                <img 
                  ...
                  className="rounded-lg shadow-2xl 
                    transform transition-all duration-500
                    group-hover:scale-105 group-hover:shadow-steam-blue/50"
                />
                <div className="absolute inset-0 bg-steam-blue/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
            </div>
          </div>

          {/* 浮动装饰元素 */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-steam-blue/10 rounded-full blur-3xl animate-pulse"></div>
