...
-- 汇总表索引
CREATE INDEX idx_summary_game_updated ON review_system.review_summary(game_id, last_updated);
CREATE INDEX idx_summary_rating ON review_system.review_summary(average_rating); 