...
export const useChat = () => {
  ...
  const handleSendMessage = useCallback(async (messageData) => {
    const { text, attachments = [], isBot = false, isQuestionSelect = false, isAnswerSelect = false } = messageData;
  ...
  }, [chatState, playMessageSound, scrollToBottom, serviceAgent, toast, selectedQuestion]);
