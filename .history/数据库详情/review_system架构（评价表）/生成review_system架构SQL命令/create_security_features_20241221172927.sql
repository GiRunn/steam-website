...
BEGIN
    -- 更全面的SQL注入检查模式
    RETURN p_text !~ '(?i)(''|;|--|\b(union|select|insert|update|delete|drop|alter|exec|execute|sp_|xp_|syscolumns|information_schema)\b|\\/\\*|\\*\\/|@@|char|nchar|varchar|nvarchar|cast|convert|declare)';
END;
