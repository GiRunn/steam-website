...
const RelatedActivities = ({ currentActivityId }) => {
  ...
  const handleActivityClick = (activityId) => {
    navigate(`/store/activity-detail/${activityId}`);
  };
              ...
              {relatedActivities.map((activity, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group relative rounded-[32px] overflow-hidden cursor-pointer bg-[#1c2127]"
                    onClick={() => handleActivityClick(activity.id)}
                  >
                    {/* 发光效果 */}
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500 rounded-[32px] blur opacity-0 group-hover:opacity-30 transition-opacity" />
                    ...
                    <div className="relative">
                      ...
                      <div className="p-6">
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-purple-500 to-cyan-500 text-white font-medium hover:shadow-lg transition-shadow"
                        >
                          查看详情
