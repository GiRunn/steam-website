...
const MediaGallery = ({ data, activityId }) => {
  ...
  const getActivityProducts = () => {
    ...
    console.log('收到的活动ID:', activityId); // 添加日志
    // 将筛选条件打印出来以便调试
    console.log('当前活动ID:', typeof activityId, activityId);
    
    // 直接使用原始值比较，不做类型转换
    const filteredGames = MOCK_GAMES.filter(game => {
      console.log('比较:', game.activityId, activityId, game.activityId === activityId);
      return game.activityId === activityId;
    });
