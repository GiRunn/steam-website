...
useEffect(() => {
  const interval = setInterval(() => {
    setCurrentPosition(prev => (prev + 1) % brandLogos.length);
  }, 3000); // 每3秒切换一次
 ...
 const brandLogos = [
  ...
  return (
    ...
    <section className="brand-showcase relative py-32 overflow-hidden bg-[#1b2838]">
      {/* 背景装饰 */}
      <div className="absolute inset-0">
            ...
            {brandLogos.map((brand) => (
              ...
              >
                <div className="max-w-4xl mx-auto">
                  <div className="group relative bg-[#2a475e] rounded-xl overflow-hidden">
            ...
            {brandLogos.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all duration-300 
                  ${currentPosition === index ? 'w-8 bg-blue-500' : 'bg-gray-400'}`}
