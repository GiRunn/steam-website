  ...
  <div className="grid grid-cols-2 gap-4 mt-8 border-t border-gray-800/50 pt-6">
    {prevPost && (
      <div className="flex flex-col">
        ...
        <a href={`/post/${prevPost.id}`} className="text-blue-400 hover:text-blue-300 truncate">
          {prevPost.title}
        </a>
      </div>
    )}
    {nextPost && (
      <div className="flex flex-col text-right">
        ...
        <a href={`/post/${nextPost.id}`} className="text-blue-400 hover:text-blue-300 truncate">
          {nextPost.title}
        </a>
      </div>
    )}
