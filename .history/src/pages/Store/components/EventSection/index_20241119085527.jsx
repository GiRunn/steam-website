      ...
      <Link to={`/event/${event.id}`} className="block">
        ...
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            <motion.h3 
              className="text-xl font-semibold text-white line-clamp-1 group-hover:text-blue-400 transition-colors flex-1 pr-4"
            >
              {event.title}
            </motion.h3>
            <motion.button
              className="p-2 bg-blue-500 hover:bg-blue-600 rounded-full shadow-lg transition-colors flex-shrink-0"
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                onSubscribe();
          ...
          <p className="text-base text-gray-400 line-clamp-2 mb-6 min-h-[3rem]">
            {event.description}
          </p>
