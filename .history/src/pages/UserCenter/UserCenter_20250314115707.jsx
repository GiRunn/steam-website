        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            <div className="flex items-center">
              ...
              <h1 className={`text-lg sm:text-xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-800'} tracking-wide`}>用户中心</h1>
            </div>
                ...
                <AnimatePresence>
                  {showNotifications && (
                    <motion.div
                      ...
                      className={`absolute right-0 mt-2 w-72 sm:w-80 ${isDarkMode ? 'bg-[#2a475e] border-gray-700' : 'bg-white border-gray-200'} border rounded-lg shadow-lg z-20`}
                    >
