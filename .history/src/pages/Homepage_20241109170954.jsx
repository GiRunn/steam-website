  ...
  const brandLogos = [
    ...
    },
    {
      ...
      svg: (
        <svg className="w-full h-full" viewBox="0 0 200 60">
          <defs>
            <linearGradient id="cheraxGradient" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" style={{ stopColor: '#9013FE', stopOpacity: 1 }} />
              <stop offset="100%" style={{ stopColor: '#BD10E0', stopOpacity: 1 }} />
            </linearGradient>
          </defs>
          <text
            x="50%"
      ...
      svg: (
        <svg className="w-full h-full" viewBox="0 0 200 60">
          ...
          <text
            ...
            textAnchor="middle"
            className="text-3xl font-bold"
            style={{ fill: 'currentColor', filter: 'url(#witch-glow)' }}
          >
            W1TCH
          </text>
        </svg>
    ...
    },
    {
      ...
      svg: (
        <svg className="w-full h-full" viewBox="0 0 200 60">
          <defs>
            <linearGradient id="nightfallGradient" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" style={{ stopColor: '#7ED321', stopOpacity: 1 }} />
              <stop offset="100%" style={{ stopColor: '#3D6610', stopOpacity: 1 }} />
            </linearGradient>
          </defs>
          <text
            x="50%"
            ...
            textAnchor="middle"
            className="text-3xl font-bold"
            style={{ fill: 'url(#nightfallGradient)' }}
          >
            NIGHTFALL
          </text>
        </svg>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1b2838] via-[#1b2838] to-[#2a475e]">
      ...
      {showVideo && (
        ...
        <div className="brand-showcase relative py-20 overflow-hidden bg-[#0B1622]">
          {/* 背景装饰 */}
          <div className="absolute inset-0">
          ...
          <div className="container mx-auto px-4">
            <div className="flex justify-center gap-16 items-center flex-wrap">
              {brandLogos.map((brand, index) => (
                <div
                  key={brand.id}
                  className="brand-logo relative group"
                  style={{
                    animation: `floatLogo 6s ease-in-out infinite ${index * 0.5}s`
                  }}
                >
                  <div className="relative w-48 h-20">
                    {/* Logo SVG */}
                    <div className="absolute inset-0 transition-all duration-500 opacity-50 group-hover:opacity-100 text-gray-400 group-hover:text-[${brand.color}]">
                      {brand.svg}
                    </div>
                    ...
                    <div 
                      ...
                      style={{
                        background: `radial-gradient(circle at center, ${brand.color}20 0%, transparent 70%)`
                      }}
                    />
                    
                    {/* 底部光线 */}
                    <div 
                      className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3/4 h-1 opacity-0 group-hover:opacity-100 transition-all duration-500 blur-sm"
                      style={{
