...
import { Star, Award, TrendingUp, BarChart2, Play, Heart } from 'lucide-react';
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 via-transparent to-blue-500/5 opacity-5" />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {games.map((game, index) => (
            ...
            >
              ...
              {/* 装饰边框 */}
              <div className="absolute inset-0 border border-blue-500/0 
                group-hover:border-blue-500/50 rounded-xl transition-all duration-300" />
            </div>
          ))}
        </div>
      </div>
