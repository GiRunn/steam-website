  ...
  return (
    <div className="absolute inset-0 bg-gradient-to-b from-[#1b2838] via-[#1b2838] to-[#1b2838]">
      ...
      <div className="brand-showcase relative py-20 overflow-hidden bg-[#0B1622]">
          ...
          {/* 渐变遮罩 */}
          <div className="absolute top-0 left-0 w-32 h-full bg-gradient-to-r from-[#0B1622] to-transparent pointer-events-none" />
          <div className="absolute top-0 right-0 w-32 h-full bg-gradient-to-l from-[#0B1622] to-transparent pointer-events-none" />
        </div>
