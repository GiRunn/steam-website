      ...
      const observer = new IntersectionObserver(
        (entries) => {
          entries.forEach((entry) => {
            ...
            if (featureId && entry.isIntersecting && !animatedFeatures[featureId]) {
        ...
        {features.map((feature, index) => (
          <div
            ...
            className={`
              ...
              ${animatedFeatures[feature.id] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}
            `}
          >
            <FeatureSection 
              feature={feature}
              index={index}
              inView={animatedFeatures[feature.id]}
            />
          </div>
        ))}
      </div>
