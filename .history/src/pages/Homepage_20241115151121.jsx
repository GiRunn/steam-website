...
// 在 Homepage 组件中修改 FeaturedGames 的集成
const GameShowcase = () => {
    ...
    <div className="min-h-screen bg-steam-dark text-white" ref={scrollRef} onScroll={handleScroll}>
      ...
      {MOCK_SECTIONS.map(section => (
        <FeaturedSection
          key={section.id}
          section={section}
          games={MOCK_GAMES.filter(game => game.sectionId === section.id)}
          isVisible={isVisible}
        />
      ))}
    </div>
...
const GAME_SCREENSHOTS = {
  1: [
    ...
    "https://cdn.akamai.steamstatic.com/steam/apps/1091500/ss_872822c5e50dc71f345416098d32dd238f9dd44a.jpg"
  ],
  2: [
    "https://cdn.akamai.steamstatic.com/steam/apps/1245620/ss_ae44317e3bd07b7690b4d62cc5d0d32a4b51fb0e.jpg",
    "https://cdn.akamai.steamstatic.com/steam/apps/1245620/ss_c372274833ae6e5a3594c3272a17d132dc93cf2a.jpg"
  ]
  // ... 其他游戏的截图
};
...
const GAME_VIDEOS = [
  {
    id: 1,
    title: "赛博朋克 2077 - 官方预告片",
    thumbnail: "https://cdn.akamai.steamstatic.com/steam/apps/256812115/movie.293x165.jpg",
    videoUrl: "https://cdn.akamai.steamstatic.com/steam/apps/256812115/movie480.webm"
  },
  {
    id: 2,
    title: "艾尔登法环 - 发售预告片",
    thumbnail: "https://cdn.akamai.steamstatic.com/steam/apps/256889456/movie.293x165.jpg",
    videoUrl: "https://cdn.akamai.steamstatic.com/steam/apps/256889456/movie480.webm"
  }
  // ... 更多视频
];
