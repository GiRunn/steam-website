...
const SystemMonitor: React.FC = () => {
    ...
    const fetchMetrics = useCallback(async () => {
        try {
            ...
            console.log('Fetched metrics history:', metricsHistoryData);
            ...
            <div className="dashboard-container">
                <div className="dashboard-grid">
                    ...
                    <div className="charts-section">
                        {metricsHistory?.cpu && metricsHistory.cpu.length > 0 && (
                            <MetricsChart 
                        ...
                        {metricsHistory?.memory && metricsHistory.memory.length > 0 && (
                            <MetricsChart 
                        ...
                        {metricsHistory?.connections && metricsHistory.connections.length > 0 && (
                            <MetricsChart 
                        ...
                        {metricsHistory?.transactions && metricsHistory.transactions.length > 0 && (
                            <MetricsChart 
