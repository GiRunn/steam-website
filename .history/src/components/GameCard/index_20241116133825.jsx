              ...
              <div className="space-y-6">
                ...
                >
                  {game.tags.map(tag => (
                    <span 
                      key={tag.id}
                      className="px-5 py-2.5 text-sm font-medium text-[#3c89e8] 
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <button 
                      ...
                      className="group/btn flex items-center gap-3 text-[#8f98a0] 
                    ...
                    {/* 分享按钮 */}
                    <button className="group/btn flex items-center gap-3 text-[#8f98a0] 
                                     hover:text-[#3c89e8] transition-colors">
