                        ...
                        <div className="performance-metrics-grid">
                            <div className="metric-detail-card">
                                ...
                                <div className="metric-detail">
                                    ...
                                    <span className="metric-value">
                                        {performanceDetails.query_performance.avg_query_time.toFixed(4)}ms
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="metric-detail-card">
                                ...
                                <div className="metric-detail">
                                    ...
                                    <span className="metric-value">
                                        {performanceDetails.query_performance.cache_hit_ratio.toFixed(2)}%
                                    </span>
                                </div>
                            </div>
                                ...
                                <div className="connection-numbers">
                                    <div className="connection-item">
                                        ...
                                        <span className="connection-value active">
                                            {performanceDetails.connection_stats.active_connections}
                                        </span>
                                    </div>
                                    <div className="connection-item">
                                        <span className="connection-label">空闲</span>
                                        <span className="connection-value idle">
                                            {performanceDetails.connection_stats.idle_connections}
                                        </span>
                                    </div>
                                    <div className="connection-item">
                                        <span className="connection-label">等待</span>
                                        <span className="connection-value waiting">
                                            {performanceDetails.connection_stats.waiting_connections}
                                        </span>
                                    </div>
                                </div>
                            </div>
