...
const Homepage = () => {
  ...
  const FeaturesContainer = ({ features }) => {
    ...
    const animatedFeatures = useRef(new Set()); // 使用 ref 来跟踪已动画的特性
            ...
            {feature.bulletPoints.map((point, idx) => (
              <li 
                ...
                style={{
                  opacity: isVisible ? 1 : 0,
                  transform: isVisible ? 'translateX(0)' : 'translateX(-2rem)',
                  transition: `opacity 600ms ${600 + idx * 100}ms, transform 600ms ${600 + idx * 100}ms`
                }}
              >
        ...
        <div className={`relative group ${!isEven && 'lg:order-1'}`}>
          ...
          <div className={`absolute -bottom-6 ${isEven ? '-right-6' : '-left-6'}
            ...
            style={{
              ...
              transition: 'opacity 600ms 800ms, transform 600ms 800ms'
            }}
          >
