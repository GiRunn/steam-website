 ...
 */
const ServiceFeature = ({ icon: Icon, text, delay = 0 }) => (
  <motion.div 
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
    transition={{ delay, duration: 0.3 }}
    className="flex items-center gap-3 p-3 rounded-lg bg-[#1a1f2c]/30 backdrop-blur-sm
      border border-gray-800/30 hover:border-gray-700/30 transition-colors"
  >
