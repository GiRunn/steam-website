...
const Homepage = () => {
  ...
  const brandLogos = [
    {
      id: 1,
      name: 'Brand 1',
      image: 'https://picsum.photos/400/200', // 更大的图片尺寸
  ...
  // 用户菜单项组件
  const UserMenuItem = ({ icon: Icon, text, count, className = "text-gray-300" }) => (
    <motion.a
      href="#"
  ...
  return (
    <div className="absolute inset-0 bg-gradient-to-b from-[#1b2838] via-[#1b2838] to-[#1b2838]">
      {/* 导航栏 */}
      <nav className={`
        sticky top-0 z-50 
        bg-steam-dark/90
          ...
          <div className="flex items-center justify-between h-16">
              ...
              <div className="relative group">
                ...
                >
                  <input
                    type="text"
                    placeholder="搜索游戏、内容..."
                    className="w-full h-10 pl-12 pr-4 rounded-full bg-[#316282]/30 
                      text-white placeholder-gray-400 outline-none
                      border border-transparent
                      focus:border-steam-blue/50 focus:bg-[#316282]/50
                ...
                {showSuggestions && (
                  <div className="absolute w-full mt-2 py-2 
                    bg-[#1e2837] rounded-xl shadow-xl border border-white/10 z-10">
                    <div className="px-4 py-1 text-xs text-gray-400 uppercase">快捷搜索</div>
                    <div className="hover:bg-white/5 px-4 py-2 text-gray-300 cursor-pointer">
                      热门游戏
                    </div>
                    <div className="hover:bg-white/5 px-4 py-2 text-gray-300 cursor-pointer">
                      新品上市
            ...
            <div className="flex items-center justify-center space-x-12">
              ...
              <motion.div className="relative">
                ...
                <motion.div
                  className="absolute -bottom-1 left-0 w-0 h-0.5 bg-steam-blue"
                ...
                <AnimatePresence>
                  {showSupportMenu && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: 10 }}
                      transition={{ duration: 0.2 }}
                      className="absolute top-full right-0 mt-2 w-64 py-2 
                        bg-[#1e2837] rounded-xl shadow-xl border border-white/10"
                      onMouseEnter={() => setShowSupportMenu(true)}
                      onMouseLeave={() => setShowSupportMenu(false)}
                    >
                      {[
                        { icon: HeadphonesIcon, text: '客户服务团队' },
                        { icon: HelpCircle, text: '常见问题解答' },
                        { icon: Video, text: '使用指导视频' },
                        { icon: Download, text: '软件下载' }
                      ].map((item) => (
                        <motion.a 
                          key={item.text}
                          href="#"
                          className="flex items-center gap-3 px-4 py-2.5 text-gray-300 
                    ...
                    >
                      <img
                        ...
                        className="w-8 h-8 rounded-full border-2 border-transparent
                          hover:border-steam-blue transition-colors"
                      />
                      ...
                      {showUserMenu && (
                        ...
                        >
                          <div className="px-4 py-2 border-b border-white/10">
                            <p className="text-white font-medium">用户名</p>
                            <p className="text-sm text-gray-400">钱包余额: $10000000000</p>
                          </div>
                          <UserMenuItem icon={User} text="个人资料" />
                          <UserMenuItem icon={Library} text="我的游戏库" />
                          <UserMenuItem icon={Heart} text="愿望清单" />
                          <UserMenuItem icon={MessageCircle} text="消息" count={2} />
                          <UserMenuItem icon={Settings} text="设置" />
        ...
        <div className="relative overflow-hidden">
          ...
          >
            ...
            {[...brandLogos, ...brandLogos, ...brandLogos].map((brand, index) => (
              <div
                key={`${brand.id}-${index}`}
                className="flex-shrink-0 px-8 w-[600px]"
              >
