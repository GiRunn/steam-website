      ...
      `}>
        ...
        <div className="relative group">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={() => toggleEmojiPicker('left')}
            className="absolute left-3 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-blue-400 transition-colors"
          >
          ...
          <textarea
            ...
            className={`
              ...
              rounded-xl resize-none p-4 px-12
          ...
          `}>
            <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              onClick={() => toggleEmojiPicker('right')}
