...
const FeaturesContainer = ({ features }) => {
  ...
  useEffect(() => {
      ...
      (entries) => {
        entries.forEach((entry) => {
          ...
          setVisibleFeatures(prev => ({
            ...prev,
            [featureId]: entry.isIntersecting // 当元素离开视窗时设置为 false
          }));
        });
      },
      {
    ...
    const scrollToSpecs = () => {
      ...
      if (specsSection) {
        specsSection.scrollIntoView({ behavior: 'instant' });
        // 防止用户看到滚动过程
        ...
        <div className={`relative group ${!isEven && 'lg:order-1'}`}>
          <div className={`
            ...
            ${isVisible 
              ...
              : `${isEven ? 'translate-x-20' : '-translate-x-20'} opacity-0 scale-95`}
          `}>
            <img 
              src={feature.image}
              alt={feature.title}
