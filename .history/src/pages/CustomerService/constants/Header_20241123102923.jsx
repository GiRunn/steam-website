          ...
          <div className="relative">
            ...
            <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2">
              ...
              <motion.button
                ...
                whileTap={{ scale: 1 }}
                type="submit"
                className="px-1.5 py-1.5 bg-blue-500/20 hover:bg-blue-500/30 
                  text-blue-400 rounded-lg border border-blue-500/30
                  transition-colors duration-200 text-sm font-medium
                  flex items-center justify-center gap-2"
              >
                <span className="flex-shrink-0">搜索</span>
                <div className="hidden sm:flex items-center gap-1 px-1 border-l border-blue-500/30">
                </div>
              </motion.button>
            </div>
          </div>
