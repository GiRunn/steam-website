          ...
          <div className="space-y-4">
            <div>
              <input
                ...
                value={formData.name}
                onChange={handleInputChange}
                className={`w-full bg-[#252a31] border ${formErrors.name ? 'border-red-500' : 'border-gray-600'} rounded px-4 py-2`}
              />
            ...
            <div>
              <input
                ...
                onChange={handleInputChange}
                className={`w-full bg-[#252a31] border ${formErrors.phone ? 'border-red-500' : 'border-gray-600'} rounded px-4 py-2`}
              />
            ...
            <div>
              <input
                ...
                onChange={handleInputChange}
                className={`w-full bg-[#252a31] border ${formErrors.email ? 'border-red-500' : 'border-gray-600'} rounded px-4 py-2`}
              />
          ...
          <div>
            <label className="flex items-center space-x-2">
              <input
                ...
                onChange={handleInputChange}
                className="form-checkbox bg-[#252a31]"
              />
              <span className="text-gray-400">我已阅读并同意活动协议</span>
            </label>
            {formErrors.agreement && <p className="text-red-500 text-sm mt-1">{formErrors.agreement}</p>}
          </div>

          {/* 总价展示 */}
          <div className="flex justify-between items-center bg-[#252a31] p-4 rounded">
