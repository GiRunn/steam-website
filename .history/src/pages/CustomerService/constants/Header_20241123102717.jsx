...
const SearchBox = ({ searchTerm, setSearchTerm, onExpand }) => {
  ...
  className="px-4 py-1.5 bg-blue-500/20 hover:bg-blue-500/30 
    ...
    flex items-center justify-center gap-2 w-full"  {/* 添加 justify-center 和 w-full */}
>
  <span className="flex-shrink-0">搜索</span>  {/* 添加 flex-shrink-0 防止文字被压缩 */}
  <div className="hidden sm:flex items-center gap-1 px-0.5 border-l border-blue-500/30">
    {/* 快捷键内容 */}
  </div>
</motion.button>
            </div>
