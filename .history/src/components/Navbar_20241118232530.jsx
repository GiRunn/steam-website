...
const Navbar = ({ darkMode, toggleDarkMode, locale, toggleLocale }) => {
  ...
  const UserMenuItem = ({ icon: Icon, text, count, className = "text-gray-300" }) => (
    <motion.a
      href="#"
      className={`flex items-center justify-between px-4 py-2.5 hover:bg-white/5 ${className}`}
      whileHover={{ x: 4 }}
    >
  ...
  return (
    <nav className="sticky top-0 z-50 bg-steam-dark/90 backdrop-blur-md border-b border-white/5">
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <Link to="/" className="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 
              ...
              >
                <input
                  ...
                  className="w-full h-10 pl-12 pr-4 rounded-full bg-[#316282]/30 
                    text-white placeholder-gray-400 outline-none border border-transparent
                    focus:border-steam-blue/50 focus:bg-[#316282]/50 transition-all duration-300"
                      ...
                      >
                        <div className="px-4 py-2 border-b border-white/10">
                          ...
                          <p className="text-sm text-gray-400">
                            钱包余额: ¥{user?.balance?.toFixed(2) || '0.00'}
                          </p>
                        </div>
                        <UserMenuItem 
                          icon={User} 
