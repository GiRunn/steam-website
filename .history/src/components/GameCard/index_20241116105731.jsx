        ...
        <div className="flex items-center gap-4">
          <div className="relative group">
            ...
            <div className="relative flex items-center">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-[#3c89e8] w-4 h-4" />
              <input
                type="text"
                placeholder="寻找你的下一个冒险..."
                className="w-64 h-10 pl-10 pr-4 bg-[#141c28]/80 rounded-md text-[#e6e7e8] 
                         placeholder-[#4d5969] outline-none border border-[#1b2736]
                         focus:border-[#3c89e8]/50 transition-all duration-300"
                value={searchQuery}
