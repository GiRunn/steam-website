  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1b2838] via-[#1b2838] to-[#2a475e]">
      ...
      <div className="container mx-auto px-4 py-8">
       ...
       <section>
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500 animate-gradient-text">
            特别优惠
          </h2>
          <button className="flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-all duration-300 group">
            查看全部
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {games.map((game, index) => (
            <div
              key={game.id}
              className="group relative bg-[#1e2837] rounded-xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]"
              onMouseEnter={() => setActiveGameIndex(index)}
              onMouseLeave={() => setActiveGameIndex(null)}
              style={{
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-10">
                <div className="bg-blue-500 text-white px-3 py-1 rounded-full font-bold text-sm transform rotate-3 animate-pulse">
                  -{game.discount}%
                </div>
              </div>
              ...
              <div className="relative aspect-[16/9] overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1e2837] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                
                {/* 悬浮时的炫光效果 */}
                <div 
                  className={`absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent transform -skew-x-12 translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-1000 ease-in-out ${
                    activeGameIndex === index ? 'opacity-100' : 'opacity-0'
                  }`}
                />
              </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2 text-gray-400">
                    ...
                    <span className="text-sm group-hover:text-blue-300 transition-colors">48:00:00 剩余</span>
                  </div>
                ...
                <button className="w-full py-2 bg-gradient-to-r from-blue-500 to-blue-600 
                  ...
                  hover:shadow-blue-500/25 group-hover:scale-105">
                  立即购买
                </button>
              </div>

              {/* 装饰性边框 */}
              <div className="absolute inset-0 rounded-xl border border-blue-500/0 group-hover:border-blue-500/50 transition-all duration-300" />
            </div>
          ))}
        </div>
      </section>
