  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row">
        {/* 游戏图片区域 - 修改了容器和图片的样式以确保等比缩放 */}
        <motion.div 
          className="relative w-full md:w-80 h-56 md:h-auto overflow-hidden group"
        ...
        >
          <motion.img
            src={product.image}
            alt={product.name}
            className="w-full h-full object-contain md:object-cover transform 
