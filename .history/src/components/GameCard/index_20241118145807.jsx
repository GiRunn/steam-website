...
import { MOCK_GAMES, GAME_FILTERS, GAME_FILTERS } from '../../pages/home/constants';
import { Tooltip } from '../../components/ui/Tooltip';
import { GAME_FILTERS } from '@/constants'; // 添加这个导入
import './styles.css';
...
const StatusTag = ({ status }) => {
  const statusConfig = GAME_STATUS[status.toUpperCase()];
