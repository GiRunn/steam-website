...
/**
 * 正常的数据库查询流程应该是:
 * 1. 前端定义接口路由 (例如在 src/api/activity.js)
 *    export const getActivity = (id) => request.get(`/api/activities/${id}`);
 * 
 * 2. 后端Controller层接收请求
...
export const ACTIVITIES_DATA = [
  {
    ...
    info: {
      ...
      relatedGames: [MOCK_GAMES[0]] // 直接使用MOCK_GAMES中的游戏数据
    },
    media: {
      promotion: [
        {
      ...
      products: [MOCK_GAMES[0]], // 直接使用MOCK_GAMES中的游戏数据
      coupons: [
        {
          value: "15%",
          type: "折扣券",
  ...
  },
  {
    ...
    info: {
      ...
      relatedGames: [MOCK_GAMES[1]] // 直接使用MOCK_GAMES中的游戏数据
    },
    media: {
      promotion: [
        {
      ...
      products: [MOCK_GAMES[1]], // 直接使用MOCK_GAMES中的游戏数据
      coupons: [
        {
          value: "10%",
          type: "折扣券",
