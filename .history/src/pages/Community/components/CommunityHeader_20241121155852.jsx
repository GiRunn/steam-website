...
const AnnouncementDialog = React.memo(({ announcement, isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-[#0f1724] rounded-2xl p-6 shadow-2xl">
          {/* 关闭按钮 */}
          <button
            onClick={onClose}
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-500 to-purple-500 p-0.5">
                <div className="w-full h-full bg-[#0f1724] rounded-[7px] flex items-center justify-center">
                  <Flame className="w-6 h-6 text-blue-400" />
                </div>
              </div>
