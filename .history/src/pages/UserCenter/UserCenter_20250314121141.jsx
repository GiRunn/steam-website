...
const UserCenter = () => {
  ...
  const tabs = useMemo(() => [
    { id: 'profile', label: '个人信息', icon: User => User },
    { id: 'orders', label: '订单列表', icon: ShoppingBag => ShoppingBag },
    { id: 'balance', label: '可用余额', icon: Wallet => Wallet },
    { id: 'wishlist', label: '关注商品', icon: Heart => Heart },
    { id: 'security', label: '账户安全', icon: Shield => Shield },
    { id: 'posts', label: '我的发帖', icon: Edit3 => Edit3 },
    { id: 'comments', label: '我的评论', icon: MessageSquare => MessageSquare },
    { id: 'collections', label: '我的收藏', icon: Bookmark => Bookmark },
    { id: 'social', label: '粉丝与关注', icon: Users => Users }
  ], []);
