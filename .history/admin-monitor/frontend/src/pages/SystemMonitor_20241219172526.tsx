                                ...
                                <div className="connection-numbers">
                                    <div className="connection-item">
                                        ...
                                        <span className="connection-value active">
                                            {loading ? '加载中...' : (state.performanceDetails?.connection_stats.active_connections || '暂无数据')}
                                        </span>
                                    </div>
                                    <div className="connection-item">
                                        <span className="connection-label">空闲</span>
                                        <span className="connection-value idle">
                                            {loading ? '加载中...' : (state.performanceDetails?.connection_stats.idle_connections || '暂无数据')}
                                        </span>
                                    </div>
                                    <div className="connection-item">
                                        <span className="connection-label">等待</span>
                                        <span className="connection-value waiting">
                                            {loading ? '加载中...' : (state.performanceDetails?.connection_stats.waiting_connections || '暂无数据')}
                                        </span>
                                    </div>
                                </div>
                            </div>
