...
const Community = lazy(() => import('./pages/Community')); // 社区主页
const CommunityPost = lazy(() => import('./pages/Community/post')); // 帖子详情页
const CommunityTopic = lazy(() => import('./pages/Community/topic')); // 话题页
const CommunityUser = lazy(() => import('./pages/Community/user')); // 用户主页
            ...
            >
              <Routes location={location}>
                ...
                <Route path="/community/topic/:id" 
                  element={
                    <motion.div {...pageTransition}>
                      <CommunityTopic {...sharedProps} />
                    </motion.div>
                  } 
                />
                <Route path="/community/user/:id" 
                  element={
                    <motion.div {...pageTransition}>
                      <CommunityUser {...sharedProps} />
                    </motion.div>
                  } 
                />
                <Route path="/support" 
