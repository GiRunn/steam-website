...
const FeaturesContainer = ({ features }) => {
  ...
  const ProductFeatures = ({ featureData }) => {
      ...
      >
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div 
              className={`
                text-center mb-16 space-y-4 transform transition-all duration-1000
                ${hasShown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}
              `}
            >
              ...
              <p className={`
                text-xl text-gray-300 max-w-3xl mx-auto transition-all duration-1000
                ${hasShown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}
              `}
              ...
              <div className={`
                ...
                ${hasShown ? 'scale-x-100 opacity-100' : 'scale-x-0 opacity-0'}
              `}
