  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1b2838] via-[#1b2838] to-[#2a475e]">
      ...
      <div className="brand-showcase relative py-20 overflow-hidden bg-[#0B1622]">
        ...
        >
          <div className="inline-flex gap-16 py-8">
            {brandLogos.map((brand, index) => (
              <div
                key={brand.id}
                className="brand-logo relative group flex-shrink-0"
                style={{
              ...
              >
                <div className="relative w-48 h-20">
                  <img
                    src={brand.image}
                    alt={brand.name}
                    className="w-full h-full object-contain opacity-50 group-hover:opacity-100 transition-all duration-500 filter grayscale group-hover:grayscale-0"
                  />
                  
                  {/* 悬浮光效 */}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-blue-500/10 rounded-lg" />
                  
                  {/* 底部光线 */}
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3/4 h-1 opacity-0 group-hover:opacity-100 transition-all duration-500 bg-gradient-to-r from-transparent via-blue-500 to-transparent blur-sm" />
                </div>
              </div>
            ))}
          </div>
