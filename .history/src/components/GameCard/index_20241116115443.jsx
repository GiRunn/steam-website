...
const GameCard = memo(({ game, index }) => {
  ...
  return (
    ...
    >
       <div className="relative aspect-[16/10] overflow-hidden"> {/* 调整比例更宽一些 */}
        <AnimatePresence>
        ...
        <AnimatePresence>
          {isHovered && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 10 }}
              className="absolute inset-0 flex flex-col justify-end p-8 {/* 增加内边距 */}
      ...
      <div className="p-6 border-t border-[#1b2736]">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-medium text-[#e6e7e8] mb-2">
              {game.title}
            </h3>
          ...
          <div className="text-right">
            {game.discount > 0 && (
               <div className="text-sm text-[#8f98a0] line-through mb-1"> 
                ¥{game.originalPrice.toFixed(2)}
              </div>
            )}
             <div className="text-xl font-bold text-[#3c89e8]">
        ...
        <div className="flex gap-2">
          <motion.button 
            className="flex-1 py-3 bg-gradient-to-r from-[#3c89e8] to-[#1b5eb8] {/* 增加按钮高度 */}
