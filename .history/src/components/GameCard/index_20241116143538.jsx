...
const GameShowcase = memo(() => {  // 使用 memo 包裹组件
  console.log('%c GameShowcase rendered', 'background: #222; color: #bada55');  // 添加样式
  
  useEffect(() => {
    console.log('GameShowcase mounted');  // 组件挂载时
    return () => console.log('GameShowcase unmounted');  // 组件卸载时
  }, []);
