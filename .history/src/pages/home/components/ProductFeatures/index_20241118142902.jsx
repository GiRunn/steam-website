...
const FeatureCard = ({ feature, index }) => {
  ...
  return (
    ...
    >
      {/* 悬停背景效果 */}
      <motion.div 
        className="absolute inset-0 bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-blue-500/20 rounded-xl blur-lg"
      ...
      {/* 卡片主体 */}
      <motion.div 
        className="relative bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700/50 h-full"
        whileHover={{ 
          y: -5,
          transition: {
            type: "spring",
      ...
      >
        ...
        {/* 图标容器 */}
        <motion.div 
          className="relative z-10 text-blue-400 mb-4"
          whileHover={{ 
            scale: 1.1,
            rotate: 5,
            transition: {
        ...
        {/* 文本内容 */}
        <motion.h3 
          className="relative z-10 text-xl font-bold text-white mb-2"
