          ...
          >
            ...
            {replies.length > 3 && !showAllReplies && (
              <button
                ...
                className="text-sm text-blue-400 hover:text-blue-300 ml-12"
              >
                查看更多回复...
              </button>
            )}
...
const ReplyItem = memo(({ reply }) => {
  ...
  return (
    <div className="group hover:bg-gray-800/30">
...
const NestedReply = memo(({ reply, onReply, parentId }) => {
  ...
  return (
    <div className="border-l-2 border-gray-700/30 ml-12 pl-4 mt-4">
      <div className="flex gap-3">
        <img
          src={reply.author.avatar}
          alt={reply.author.name}
