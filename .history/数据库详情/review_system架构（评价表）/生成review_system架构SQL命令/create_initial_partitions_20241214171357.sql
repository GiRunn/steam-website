...
-- 预创建未来6个月的分区（可以根据需要调整）
SELECT review_system.create_future_partitions(6);

-- 创建定时任务记录
INSERT INTO review_system.maintenance_jobs (job_type, last_run, next_run)
VALUES ('partition_maintenance', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + interval '1 day')
