...
// 确保所有的 SectionIcon 使用都有正确的 type prop
...
const Homepage = () => {
  ...
  }, [startAutoScroll]); // 添加 startAutoScroll 到依赖数组
  ...
  // 修复 intersection observer useEffect
  useEffect(() => {
    const currentRef = introRef.current; // 在 effect 中保存 ref 值
  ...
  return (
    <div className="min-h-screen bg-steam-dark text-white" ref={scrollRef} onScroll={handleScroll}>
      ...
      {renderSectionIcon(CONTENT_TYPES.NEW)}
      <div>
