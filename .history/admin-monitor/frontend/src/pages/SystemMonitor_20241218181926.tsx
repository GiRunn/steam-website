...
interface DatabasePerformance {
    ...
    transactions_per_second: number | string;
    cache_hit_ratio: number | string;
    index_hit_ratio: number | string;
}
            ...
            >
                ...
                {databasePerformance && (
                    ...
                    >
                        ...
                        <p>每秒事务数: {Number(databasePerformance.transactions_per_second || 0).toFixed(2)}</p>
                        <p>缓存命中率: {Number(databasePerformance.cache_hit_ratio || 0 * 100).toFixed(2)}%</p>
                        <p>索引命中率: {Number(databasePerformance.index_hit_ratio || 0 * 100).toFixed(2)}%</p>
                    </div>
                )}
            </div>
        </div>
