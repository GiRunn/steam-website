...
const FeaturesContainer = ({ features }) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const featuresElement = document.querySelector('.features-container');
      if (featuresElement) {
  ...
  return (
    <div className={`features-container mt-20 space-y-20 transform transition-all duration-1000 ${
