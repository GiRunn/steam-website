        ...
        try {
            ...
            setMetrics({
                ...
                database: [
                    { 
                        name: '数据库大小', 
                        value: systemData?.database_size ? 
                            parseFloat(systemData.database_size) : 
                            Math.round(systemData?.database_size_bytes / (1024 * 1024)) || 0, 
                        unit: 'MB', 
                        trend: 'up' 
                    },
                    { 
                        name: '连接数', 
                        value: systemData?.active_connections || 0, 
                        trend: 'stable' 
                    }
                ],
                connections: [
