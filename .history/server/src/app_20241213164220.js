...
// 在现有的导入语句下添加
const initializeGameIntroduction = require('./modules/gameIntroduction');

// 在现有的导入语句下添加
const initializeGameBasicInfo = require('./modules/gameBasicInfo');

// 在现有的导入语句下添加
const initializePromotion = require('./modules/promotion');

// 在现有的导入语句下添加
const initializeGameList = require('./modules/gameList');
...
app.use('/api/v1/games', initializeGameIntroduction(pool, redis));
app.use('/api/v1/games', initializeGameBasicInfo(pool, redis));
app.use('/api/v1/promotions', initializePromotion(pool, redis));
app.use('/api/v1/games', initializeGameList(pool, redis));
